...
Template::ExpandHash - The great new Template::ExpandHash!
...
Perhaps a little code snippet.
    ...
    my $foo = Template::ExpandHash->new();
    ...
...
Please report any bugs or feature requests to C<bug-template-expandhash at rt.cpan.org>, or through
the web interface at L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=Template-ExpandHash>.  I will be notified, and then you'll
